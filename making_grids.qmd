...
There are three geometric shapes that can produce the regular tessellation of a surface: squares, hexagons, and triangles.
...
irreg_triangle_grid <- function(polygon, n) {
  if (isTRUE(inherits(polygon, "sf"))) {
    polygon <- vect(polygon)
  }
